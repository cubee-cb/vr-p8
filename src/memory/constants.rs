...
///
pub const VR_TRANS_STRIDE: i64 = 8;

pub const VR_TRANSBUFFER_SIZE: i64 = 16384;
pub const VR_MAX_TRANSFORMS: i64 = VR_TRANSBUFFER_SIZE / VR_TRANS_STRIDE;
//pub static VR_MAX_TRANS_BYTES: i64 = VR_TRANSBUFFER_SIZE_ADDR * 8;
